import { Cocktail, Tag } from '@/schema'
...
export type UseSearchCocktailsProps = { cocktailsQuery: UseTRPCQueryResult<Cocktail[], unknown> }

export function useSearchCocktails({ cocktailsQuery }: UseSearchCocktailsProps) {
  ...
  const cocktails = useMemo(() => {
    return tagCocktails.data?.map(({ cocktail }) => cocktail) ?? cocktailsQuery.data ?? []
  }, [cocktailsQuery, tagCocktails])
